...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='unet_256', help='selects model to use for netG. `resnet_9blocks` or `unet_256`')
        ...
        self.parser.add_argument('--visdom', type=str, default='off', help='if off, run visdom server for visualization of training results')
